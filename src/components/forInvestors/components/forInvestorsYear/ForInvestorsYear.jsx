...
class ForInvestorsYear extends Component {
  state = {
    firstName: '/charts',
  ...
  componentDidUpdate(prevProps, prevState, snapshot) {
    ...
    if (prevState.searchChartId !== searchChartId) {
      getChart(searchChartId)
    }
  }
...
export default connect(MSTP, MDTP)(ForInvestorsYear)
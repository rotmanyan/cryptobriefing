...
class ForInvestorsHalfYear extends Component {
  state = {
    firstName: '/charts',
...
const MSTP = state => ({
  news: selector.chartsNews(state),
  prices: selector.chartsPrices(state),
  name: selector.chartsName(state),
...
export default connect(MSTP, MDTP)(ForInvestorsHalfYear)